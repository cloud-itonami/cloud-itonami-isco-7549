...
- safety-critical escalation path (hand-tool hazard,
  material-handling hazard, equipment condition)
...
- a hard, unconditional block on any attempt to route a
  craft-execution decision, a product-quality/safety-clearance
